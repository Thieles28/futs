                                ...
                                <div class="table-responsive b-0" data-pattern="priority-columns">
                                    <table id="tech-companies-1" class="table  table-striped display-all focus-on">
                                        ...
                                        <tr>
                                            ...
                                            <td data-priority="3" colspan="1" data-columns="tech-companies-1-col-2">{{ str_limit($pagina->titulo_patrocinio, 30) }}</td>
                                            <td data-priority="3" colspan="1" data-columns="tech-companies-1-col-2">{{ str_limit($pagina->tipo, 10) }}</td>
                                            <td class="actions">
                                                <a href="{{ route('editar_patrocinio', $pagina->id) }}" class="on-default edit-row"><i class="fa fa-pencil"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                        </tbody>
